    ...
    <div class="card">
        <div class="card-body">
            <form method="post" action="<?php echo site_url('dashboard/configSave'); ?>">
                ...
                <div class="mb-3">
                    <label for="minplay" class="form-label">Valor máx. saque automático</label>
                    <input type="number" class="form-control" id="minSaqueAutomatico" name="minSaqueAutomatico" value="<?php echo $config[0]->minSaqueAutomatico ?>">
                </div>
