            ...
            <form class="row" method="post" action="<?php echo site_url('dashboard/saveAfiliados'); ?>">
                ...
                <div class="col-md-6 mt-2">
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group mb-1">
                                <label for="porcentagemIndicacao">Porcentagem de Indicação (%):</label>
                                <input type="text" id="porcentagemIndicacao" name="porcentagemIndicacao" class="form-control" value="<?php echo $afiliado[0]->porcentagemIndicacao ?>">
                            </div>
                        </div>
                    </div>
                </div>
