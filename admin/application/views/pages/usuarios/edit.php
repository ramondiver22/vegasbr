        ...
        <div class="card bg-card-black">
            <div class="card-body">
                <form method="post" action="<?php echo site_url('usuarios/update/'.$user->id); ?>">
                    ...
                    <div class="mb-3">
                        <label for="nome" class="form-label">É Afiliado?</label>
                        <select name="is_afiliado" class="form-control">
                            <option value="0" <?=($user->is_afiliado == 0) ? 'selected' : '' ?>>Não</option>
                            <option value="1" <?=($user->is_afiliado == 1) ? 'selected' : '' ?>>Sim</option>
                        </select>
                    </div>
                    <div class="mb-3">
