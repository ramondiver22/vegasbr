<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <form method="post" action="<?php echo site_url('GatewayPagamento/save/ezzebank'); ?>">
            <div class="mb-3">
            ...
            <?php if ($isSuitPay == true): ?> 
                <input type="text" class="form-control" placeholder="Desative a gateway SuitPay para habilitar essa gateway">
            <?php else: ?>
