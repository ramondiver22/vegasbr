...
class Welcome extends CI_Controller {
...

	{
		...
		$queryAll = "SELECT * FROM games LIMIT 60;";
	...
	public function busca() {
		$query = $this->input->post('keywords');
		$queryAll = "SELECT * FROM games WHERE game_name LIKE '%{$query}%' LIMIT 24;";
		$data['jogos'] = $this->db->query($queryAll)->result();
		$this->load->view('pages/welcome/busca', $data);
	}
}
