...
class Cassino extends CI_Controller {
	...
	public function blackjack()
	{
		...
		$q = "SELECT p.name AS provider, g.game_name, g.banner, g.game_code FROM provedores p RIGHT JOIN games g ON p.code = g.provider WHERE p.type = 'live' and game_name like '%blackjack%'";
	...
	public function bacara()
	{
		...
		$q = "SELECT p.name AS provider, g.game_name, g.banner, g.game_code FROM provedores p RIGHT JOIN games g ON p.code = g.provider WHERE p.type = 'live' and game_name like '%baccara%'";
