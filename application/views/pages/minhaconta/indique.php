      ...
      <div class="card-affiliate horizontal mb-16">
         <div class="item-card-affiliate">
            ...
            <div class="content-card-affiliates">
               <h4>Referências</h4>
               <h4 invited-users-quantity=""><?=$afiliados[0]->referencia?></h4>
            </div>
         </div>
         <div class="item-card-affiliate">
            <img src="https://assets-global.website-files.com/6483631a773f6af2b4edabab/651ff9c472a75899e996ef0a_users.svg" loading="lazy" alt="" class="icon-medium">
            <div class="content-card-affiliates">
               <h4>Ativos</h4>
               <h4 invited-active-users-quantity=""><?=$afiliados[0]->referencia?></h4>
            </div>
         </div>
         <div class="item-card-affiliate">
         ...
         <div class="item-card-affiliate">
            ...
            <div class="content-card-affiliates">
               ...
               <h4 invited-users-sum-commissions="">R$<?=number_format($afiliados[0]->total,2,",",".");?></h4>
            </div>
         </div>
      </div>
                  ...
                  <div class="content-select-field mt-24">
                     <?php if ($usuario[0]->usuario !== null): ?>
                        <div class="eng-select-field full">
                           <input type="text" class="input w-input" maxlength="256" id="afiliadotext" name="name-2" data-name="Name 2" placeholder="Carregando..." value="<?= base_url(); ?>?ref=<?php echo $usuario[0]->usuario ?>" >
                        </div>
